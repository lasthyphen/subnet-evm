...
It is also helpful to have a basic understanding of [Solidity](https://docs.soliditylang.org) and [Avalanche](https://docs.djtx.network).
...
For more information about precompiles see [subnet-evm precompiles](https://github.com/lasthyphen/subnet-evm#precompiles).
