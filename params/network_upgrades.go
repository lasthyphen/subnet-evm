...
// NetworkUpgrades contains timestamps that enable dijets network upgrades.
type NetworkUpgrades struct {
	SubnetEVMTimestamp *big.Int `json:"subnetEVMTimestamp,omitempty"` // A placeholder for the latest dijets forks (nil = no fork, 0 = already activated)
}
