module github.com/lasthyphen/subnet-evm/cmd/simulator

go 1.18

require (
	github.com/lasthyphen/subnet-evm v0.0.0-00010101000000-000000000000
...
replace github.com/lasthyphen/subnet-evm => ../..
