...
[![Build + Test + Release](https://github.com/lasthyphen/subnet-evm/actions/workflows/lint-tests-release.yml/badge.svg)](https://github.com/lasthyphen/subnet-evm/actions/workflows/lint-tests-release.yml)
[![CodeQL](https://github.com/lasthyphen/subnet-evm/actions/workflows/codeql-analysis.yml/badge.svg)](https://github.com/lasthyphen/subnet-evm/actions/workflows/codeql-analysis.yml)

[Avalanche](https://docs.djtx.network/overview/getting-started/avalanche-platform) is a network composed of multiple blockchains.
Each blockchain is an instance of a Virtual Machine (VM), much like an object in an object-oriented language is an instance of a class.
That is, the VM defines the behavior of the blockchain.

Subnet EVM is the [Virtual Machine (VM)](https://docs.djtx.network/overview/getting-started/avalanche-platform/#virtual-machines) that defines the Subnet Contract Chains. Subnet EVM is a simplified version of [Coreth VM (C-Chain)](https://github.com/ava-labs/coreth).
...
Full documentation for the C-Chain's API can be found [here.](https://docs.djtx.network/apis/avalanchego/apis/c-chain)

## Compatibility

The Subnet EVM is compatible with almost all Ethereum tooling, including [Remix](https://docs.djtx.network/dapps/smart-contracts/deploy-a-smart-contract-on-avalanche-using-remix-and-metamask/), [Metamask](https://docs.djtx.network/dapps/smart-contracts/deploy-a-smart-contract-on-avalanche-using-remix-and-metamask/) and [Truffle](https://docs.djtx.network/dapps/smart-contracts/using-truffle-with-the-avalanche-c-chain/).
...
[`scripts/run.sh`](https://github.com/lasthyphen/subnet-evm/blob/master/scripts/run.sh) automatically installs `avalanchego`, sets up a local network,
...
cd ${HOME}/go/src/github.com/lasthyphen/subnet-evm
git pull
...
Note that this ewoq address (`0x8db97C7cEcE249c2b98bDC0226Cc4C2A57BF52FC`) is a prefunded address on the local network, see [here](https://docs.djtx.network/quickstart/fund-a-local-test-network) for more info. The private key for this address is
...
```bash
> go run main.go
go: downloading github.com/lasthyphen/subnet-evm v0.1.2
...
See [this tutorial](https://docs.djtx.network/subnets/create-a-fuji-subnet-subnet-cli).

## Customize a Subnet

- [Genesis](https://docs.djtx.network/subnets/customize-a-subnet#genesis)
- [Precompile](https://docs.djtx.network/subnets/customize-a-subnet#precompiles)
- [Priority Regossip](https://docs.djtx.network/subnets/customize-a-subnet#priority-regossip)
...
```text
Network Name: WAGMI
RPC URL: https://subnets.djtx.network/wagmi/wagmi-chain-testnet/rpc
Chain ID: 11111
Symbol: WGM
Explorer: https://subnets.djtx.network/wagmi/wagmi-chain-testnet/explorer
```
