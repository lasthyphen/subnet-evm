...
import (
	...
	"github.com/lasthyphen/subnet-evm/tests/utils"
	...
	_ "github.com/lasthyphen/subnet-evm/tests/precompile/solidity"
)
...
// BeforeSuite starts an DIJETSNODE process to use for the e2e tests
var _ = ginkgo.BeforeSuite(func() {
	...
	log.Info("Starting DIJETSNODE node", "wd", wd)
	...
	log.Info("DIJETSNODE node is healthy")
})
