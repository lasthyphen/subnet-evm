...
var bindTests = []struct {
	...
	// Test that contract interactions (deploy, transact and call) generate working code
	{
		...
		`
			...
			"github.com/lasthyphen/subnet-evm/accounts/abi/bind/backends"
...
func golangBindings(t *testing.T, overload bool) {
	...
	pwd, _ := os.Getwd()
	replacer := exec.Command(gocmd, "mod", "edit", "-x", "-require", "github.com/lasthyphen/subnet-evm@v0.0.0", "-replace", "github.com/lasthyphen/subnet-evm="+filepath.Join(pwd, "..", "..", "..")) // Repo root
	replacer.Dir = pkg
