...
go build -ldflags "-X github.com/lasthyphen/subnet_evm/plugin/evm.GitCommit=$subnet_evm_commit -X github.com/lasthyphen/subnet_evm/plugin/evm.Version=$subnet_evm_version" -o "$binary_path" "plugin/"*.go
